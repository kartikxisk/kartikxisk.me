      ...
      <AnimatePresence>
        {isVisible && (
          <motion.button
            ...
            whileTap={{ scale: 0.95 }}
            className="fixed bottom-20 right-6 z-50 flex items-center gap-2 rounded-full border border-purple-500/30 bg-purple-500/10 px-4 py-2 text-sm font-medium text-purple-400 backdrop-blur-sm transition-all hover:border-purple-500/50 hover:bg-purple-500/20 hover:text-purple-300 disabled:cursor-not-allowed disabled:opacity-50 md:bottom-24 md:right-8"
          >
